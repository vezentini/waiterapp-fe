...
import { OrderModal } from '../OrderModal/Order';
...
export function OrdersBoard({ icon, title, orders, onCancelOrder, onOrderStatusChange }: OrdersBoardProps) {
    ...
    async function handleChangeOrderStatus() {
        ...
        toast.success(`O pedido da ${selectedOrder?.table} teve o status alterado!`);
    ...
    async function handleCancelOrder() {
        ...
        toast.success(`O pedido da ${selectedOrder?.table} foi cancelado!`);
